...
const ciudades = [
  {
    ...
    id: "Tokyo",
    imagen:
      "https://porlavision.com/wp-content/uploads/2020/05/Visita-a-Tokio-desde-la-casa-1024x683.png",
  },
  {
    pais: "South Korea",
    nombre: "Busan",
    ...
    id: "Busan",
    imagen:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Haedong_Yonggungsa%2C_Busan.jpg/750px-Haedong_Yonggungsa%2C_Busan.jpg",
  },
  ...
  return (
    <>
      <ScrollView style={{ width: widthScreen, backgroundColor: "#414141" }}>
        ...
        <Text style={styles.popular}>Popular MyTineraries</Text>
